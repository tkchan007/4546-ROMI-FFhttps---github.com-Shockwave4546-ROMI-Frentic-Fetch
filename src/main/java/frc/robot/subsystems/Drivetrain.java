...
public class Drivetrain extends SubsystemBase {
  private static final double kCountsPerRevolution = 1440.0; // About 1440 counts per rev
  private static final double kWheelDiameterMeter = 0.07; // 70mm
  ...
  // Initial Heading values stored into special variable
  private double m_initial_heading = 0.0;
  ...
  public void arcadeDrive(double xaxisSpeed, double zaxisRotate) {
    m_diffDrive.arcadeDrive(xaxisSpeed * 0.45, zaxisRotate * 0.45);
  }
  ...
  /** using the direct drive the diff motors */
  public void motorSpeed(double lmotor_speed, double rmotor_speed) {
    m_diffDrive.tankDrive(lmotor_speed, rmotor_speed);
  }
  ...
  public void setInitHeading() {
    m_initial_heading = m_gyro.getAngleZ();
    SmartDashboard.putNumber("My Initial Heading:", m_initial_heading);
  }

  public double getInitHeading() {
    return m_initial_heading;
  }
